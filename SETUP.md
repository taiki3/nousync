...
### 環境URL
| 環境 | Vercel URL | Supabase |
|------|------------|----------|
| 本番 | https://nousync.vercel.app | nousync-prod |
| 開発 | https://nousync-git-dev-agc-di-17ee7fbb.vercel.app | nousync-dev |

### E2Eテスト
```bash
# .env.local に以下を設定
E2E_BASE_URL=https://nousync-git-dev-agc-di-17ee7fbb.vercel.app
